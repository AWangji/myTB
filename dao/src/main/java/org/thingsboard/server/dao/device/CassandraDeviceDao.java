...
public class CassandraDeviceDao extends CassandraAbstractSearchTextDao<DeviceEntity, Device> implements DeviceDao {
    ...
    @Override
    public Device save(TenantId tenantId, Device domain) {//把设备与用户的关联关系存入数据库
    ...
    @Override
    public List<Device> findDevicesByTenantId(UUID tenantId, TextPageLink pageLink) {//显示tenant拥有的设备名
